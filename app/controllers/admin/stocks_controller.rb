class Admin::StocksController < AdminController
  ...
  def update
    @admin_stock = Stock.find(params[:id])
    @admin_product = @admin_stock.product

    respond_to do |format|
      if @admin_stock.update(admin_stock_params)
        format.html { redirect_to admin_product_stocks_url(@admin_product, @admin_stock), notice: "Stock was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_product_stocks_url(@admin_product, @admin_stock), notice: "Stock was successfully destroyed." }
